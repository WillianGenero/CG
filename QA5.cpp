...
float rotX = 0, rotY = 0, rotZ = 0, ang = 1, scale = 1;
...
void display()
{
	...
	glColor3f(0, 0, 1);
	glScalef(0.+scale, 0.+scale, 1);
	glRotatef(0.f+ang, 0.f+rotX, 0.f+rotY, 0.f+rotZ);
...
void keyboard(unsigned char key, int x, int y)
{
	if (key == 27)
		...
		rotX = rotY = rotZ = 0;
	else if (key == 49) //ROT X
		rotX = 1;
	else if (key == 50) //ROT Y
		rotY = 1;
	else if (key == 51) //ROT Z
		rotZ = 1;
	else if (key == 65) //Scale 2
		scale = 2;
	else if (key == 66) //Scale 1
		scale = 1;
	else if (key == 67) //Scale 1/2
		scale = 0.5;
}
